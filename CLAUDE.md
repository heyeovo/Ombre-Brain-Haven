...
GET    /gateway/api/conversation/session?session_id=&include_bucket_exclusions=1&include_context_days=1
       # 窗口状态、滚动配置/revision/watermark、可选日期清单（含各内容模块的按日 token 预估），以及按当前可见原文日期过滤的桶排除集合
