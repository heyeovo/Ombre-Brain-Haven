...
def load_config(config_path: str = None) -> dict:
    ...
    defaults = {
        ...
        "reflection": {
            ...
            "daily_chat_memory_api_key_env": "HANDOFF_SUMMARIZER_API_KEY_2",
            "daily_chat_memory_base_url": "https://api.siliconflow.cn/v1",
            "daily_chat_memory_timeout_seconds": 180,
            "daily_chat_memory_summary_model": "Qwen/Qwen3.5-4B",
